DISPLAY_PAGE_HOME_POWER_ON = f'''Se vuoi avviare il generatore, clicca l'icona "POWER" (switch verde, posizione destra).'''
DISPLAY_PAGE_HOME_POWER_OFF = f'''Clicca l'icona "POWER" per spegnere il generatore (switch rosso, posizione sinistra).'''
...
DISPLAY_PAGE_CALENDAR_ENABLE_OFF = f'''Clicca l'icona "FRECCIA IN BASSO" per selezionare l'opzione "OFF".'''
DISPLAY_PAGE_CALENDAR_ENABLE_SAVE = f'''Clicca l'icona "SALVA" per confermare la selezione.'''
